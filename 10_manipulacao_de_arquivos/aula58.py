...
nome_arquivo = "resumo_do_livro_o_pequeno_principe.pdf"
...
# Crie uma lista para armazenar os parágrafos do texto
conteudo = []
...
# Divida o texto completo em parágrafos
paragrafos = texto_completo.split("\n\n")

# Adicione cada parágrafo à lista de conteúdo
